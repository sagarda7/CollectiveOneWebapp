...
import org.collectiveone.modules.initiatives.MemberDto;
...
public class CommentsController { 
	...
	@RequestMapping(path = "/secured/comments", method = RequestMethod.POST)
	public PostResult createComments(@RequestBody CommentsDto commentsDto) {
		
		String intiativeId = commentsDto.getIntiativeId();
		
		MemberDto member = initiativeService.getMember(UUID.fromString(intiativeId), getLoggedUser().getC1Id());
